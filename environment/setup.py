...
setup(
    ...
    author='Santoki-Het' ,# author of the package
    author_email='santokihet63@gmail.com', # email of the author
    url='https://github.com/HetSantoki/Bank-Marketing-predection.git', # url of the project
